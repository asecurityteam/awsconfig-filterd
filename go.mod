...
require (
	github.com/asecurityteam/component-httpclient v0.4.1
...
require (
	...
	github.com/asecurityteam/transport v1.6.6 // indirect
	github.com/asecurityteam/transportd v1.6.1 // indirect
